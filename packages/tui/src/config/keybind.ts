...
export const Definitions = {
  ...
  sidebar_toggle: keybind("<leader>v", "Toggle sidebar"),
  ...
  session_btw: keybind("<leader>b", "Open BTW side chat"),
  session_btw_close: keybind("<leader>p", "Close BTW side panel"),
...
export const CommandMap = {
  ...
  session_btw_close: "session.btw.close",
