...
export const Info = Schema.Struct({
  ...
  instructionsExclude: Schema.optional(Schema.mutable(Schema.Array(Schema.String))).annotate({
    description: "Glob patterns of instruction files to exclude; matched relative to the project root",
  }),
